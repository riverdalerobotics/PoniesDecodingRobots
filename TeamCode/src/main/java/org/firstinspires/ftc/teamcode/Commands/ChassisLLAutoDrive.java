...
public class ChassisLLAutoDrive extends CommandBase {
    ...
    public ChassisLLAutoDrive(ChassisSubsystem chassis, LLsubsystem limelight, Telemetry telemetry, Pose target){
