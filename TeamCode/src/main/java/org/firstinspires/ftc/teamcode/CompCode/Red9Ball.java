...
@Autonomous(group = "Red Auto", name = "Red 9 Ball without gate")
public class Red9Ball extends CommandOpMode {
    ...
    public void run(){
        ...
        if (run){schedule(new SequentialCommandGroup(
                ...
                new ChassisLLAutoDrive(chassis, limelight, telemetry, RobotConstants.RedAuto.RED_FIRST_INTAKE_POSE),
                ...
                new ChassisLLAutoDrive(chassis, limelight, telemetry, RobotConstants.RedAuto.RED_SCORE_POSE),
                new ChassisLookToAprilTagInAutoRed(chassis, limelight, telemetryM, 0),
                new ParallelDeadlineGroup(
                ...
                new ShootAllThree(snap, crackle, pop, telemetry),
                new ChassisLLAutoDrive(chassis, limelight, telemetry, RobotConstants.RedAuto.RED_SECOND_INTAKE_POSE),
                new ChassisLLAutoTurn(chassis, limelight, telemetry, -90),
                new ParallelDeadlineGroup(
                        new Timer(RobotConstants.Teleop.DRIVE_FORWARD_AUTO),
                        new IntakeCommand(intake, snap, crackle, pop),
